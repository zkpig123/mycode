...
int _merge_sort_guard_incremental_guard (int cards[], size_t card_num)
{
	...
	_merge_sort_guard_incremental_guard(cards, left_card_num);
	_merge_sort_guard_incremental_guard(cards + mid, right_card_num);
...
int _merge_sort_guard_decremental_guard (int cards[], size_t card_num)
{
	size_t left_card_num;
	size_t right_card_num;
	size_t mid = card_num / 2;
...
int merge_sort_guard (int cards[], size_t card_num, int order)
{
	...
	if (order > 0) _merge_sort_guard_incremental_guard(cards, card_num);
	else _merge_sort_guard_decremental_guard(cards, card_num);
	return 0;
}
