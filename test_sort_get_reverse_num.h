...
void print_success_msg (int cur_func, double elapsed, size_t reverse);
void print_success_msg_fd (int cur_func, double elapsed, size_t reverse);
...
void various_sort_cards (int cards[], int orig_cards[], size_t card_num, int(*func[])(int[], size_t, int, size_t*), size_t func_num);
